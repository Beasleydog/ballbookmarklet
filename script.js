 if (document.getElementById('Ball') == null) {
     ...
     var cjumpy = 0;
     var newjump = 1;
     var jumpx = Math.random() * 1300 + 10;
     var jumpy = Math.random() * 200 + 200;
     var changescore = 0;
     var ballwidth = 50;
     var ballheight = 50;
     var toldscore = 0;
     ...
     Jump.style.zindex = 999;
     Jump.src = "https://sites.google.com/site/picturesforgame/_/rsrc/1526217114260/home/Blank.png";
     Jump.style.position = 'fixed';
     Jump.width = 30;
     Jump.height = 30;
     Jump.select = 'none';
     Jump.id = 'Jump';
     Jump.style.marginLeft = jumpx + "px";
     Jump.style.top = jumpy + "px";
     document.body.insertBefore(Jump, document.body[0]);
